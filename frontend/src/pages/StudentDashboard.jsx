...
export default function StudentDashboard() {
  ...
  return (
    <div className="p-6">
      ...
      <table className="w-full border bg-white rounded-lg shadow mb-4">
        <thead>
        ...
        <tbody>
          {displayedRequests.map((r) => (
            <tr key={r._id} className="border-t text-center hover:bg-gray-50">
              ...
              <td className="p-3">
                ...
                >
                  {r.assignedTo?.name || "Not assigned"}
                </span>
              </td>
              <td className="p-3">
                <span
